...
@synthesize img,path,lineColor,incrementalImage;
...
-(void)MultiColorPath{
    ...
    path.lineWidth=6.0;
    int randomNumber = 0 + rand() % (6-0);
    [[colors objectAtIndex:randomNumber]setStroke];
...
- (void)drawBitmap
{
       ...
       if (!incrementalImage) // first time; paint background white
       {
           ...
           //check this for only black theme
           if (!self.themeSet) {
